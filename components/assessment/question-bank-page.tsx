...
const difficultyTone: Record<Difficulty, string> = { EASY: "bg-emerald-50 text-emerald-700", MEDIUM: "bg-amber-50 text-amber-700", HARD: "bg-rose-50 text-rose-700", VERY_HARD: "bg-violet-50 text-violet-700" };
...
export function QuestionBankPage() {
  ...
  return <AssessmentShell><PageHeading eyebrow="Teacher workspace" title="Ngân hàng câu hỏi" description="Quản lý câu hỏi dùng chung cho các bài kiểm tra. Dữ liệu được lưu trực tiếp trên Backend." action={<div className="flex flex-wrap gap-2"><Link href="/teacher/question-bank/generate"><Button variant="secondary"><Sparkles className="size-4" />Tạo bằng AI</Button></Link><Link href="/teacher/question-bank/new"><Button>+ Tạo câu hỏi</Button></Link></div>} />
